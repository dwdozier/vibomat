...
This guide covers the prerequisites, installation, and configuration required to run the Spotify Playlist Builder.

## Prerequisites

- **Python 3.11+**
- **uv package manager**: [Installation Instructions](https://docs.astral.sh/uv/getting-started/)
- **Spotify Developer Credentials**: Follow the [App Registration Guide](APP_REGISTRATION.md) to get your Client ID and Client Secret.
...
You need to provide your Spotify credentials to the application. You can do this using either a `.env` file (easier) or your system's secure keychain (more secure).
...
This method stores your credentials encrypted in your operating system's default keychain (e.g., macOS Keychain, Windows Credential Manager).
